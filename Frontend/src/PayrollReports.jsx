    ...
    <div className="px-4 py-5">
        ...
        <div className="card-body">
          <div className="row align-items-center gy-3">
            <div className="col-md">
              <p className="text-uppercase fw-semibold small text-info mb-1">Báo cáo lương</p>
              <h1 className="h4 mb-2">Payroll Reports</h1>
              <p className="text-secondary mb-0">Tổng hợp số liệu chi phí lương, phụ cấp và hiệu suất thanh toán.</p>
            </div>
      ...
      <section className="row g-4">
          ...
          <div className="card shadow-sm h-100">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-4">
                <h2 className="h5 mb-0">Phân tích chi phí</h2>
              ...
              <div className="row g-3">
                <div className="col-md-6">
                  <div className="card border-0 bg-light h-100">
                    <div className="card-body">
                      <p className="text-secondary mb-1">Chênh lệch lương</p>
                      <p className="h4 mb-0">+8%</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="card border-0 bg-light h-100">
                    <div className="card-body">
                      <p className="text-secondary mb-1">Phụ cấp</p>
                      <p className="h4 mb-0">{formatVnd(4200000)}</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="card bg-light border-0 mt-4">
                <div className="card-body">
                  <p className="fw-semibold mb-2">Xu hướng</p>
        ...
        <div className="col-xl-5">
          <div className="card shadow-sm h-100">
            <div className="card-body">
              <h2 className="h5">Insights nhanh</h2>
              <div className="mt-4">
